...
public class Schedule extends EventTime {
    ...
    public  Schedule(ScheduleByProfessionalForm eventForm, Set<Job> jobs, Long tenant) {
        this.jobs = jobs;
        this.price = eventForm.getEvent().getValue();
        this.hasPaymentReceived = eventForm.getEvent().isHasPaymentReceived();
        this.date = eventForm.getEvent().getEventDate();
        this.customer = new Customer(eventForm.getCustomerId());
        setStartTime(eventForm.getEvent().getStartTime());
